...
for connectivityInfo in coreInfo.connectivityInfoList:
    ...
    myAWSIoTMQTTClient1.configureEndpoint('192.168.1.2', currentPort)
    myAWSIoTMQTTClient2.configureEndpoint('192.168.1.3', currentPort)
    myAWSIoTMQTTClient3.configureEndpoint('192.168.1.4', currentPort)
    myAWSIoTMQTTClient4.configureEndpoint('192.168.1.7', currentPort)
